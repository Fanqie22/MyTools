function checkusernumber() {
	...
	if (strValue == '' || strValue.length == 0 || strValue == null) {
		span.innerHTML = " &nbsp; &nbsp; &nbsp; &nbsp;用 户 名 不 能 为 空 哦 !";
		...
		span.innerHTML = " 用 户 名 为 邮 箱 或 者 手 机 号 码 哦 !";
		span.style.color = "red";
		return false;
	}
...
function checkpassword() {
	...
	if (strValue == null || strValue.length == 0) {
		...
		span.innerHTML = " 这 不 可 能 是 正 确 的 密 码 !";
		span.style.color = "red";
		return false;
	}
}
...
function checkloginVerificationCode() {
	...
	if (strValue == null || strValue.length == 0) {
		span.innerHTML = " &nbsp; &nbsp; &nbsp; 验 证 码 不 能 为 空 哦 !";
		span.style.color = "red";
		return false;
		...
		span.innerHTML = " 这 不 可 能 是 正 确 的 验 证 码 !";
		span.style.color = "red";
		return false;
	}
}
